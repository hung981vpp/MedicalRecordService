...
{
    /// <inheritdoc />
    public partial class UseBusinessCodeIds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DoctorId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PrescriptionId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    RecordId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PrescriptionItemId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PrescriptionId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MedicineId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
